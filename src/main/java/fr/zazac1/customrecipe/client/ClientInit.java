...
public class ClientInit implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            CustomRecipeMod.LOGGER.info("[Custom Recipes] Editor tip check: world='{}', id='{}', instance='{}', day={}, alreadyShown={}",
                    levelName, worldId, worldInstanceId, day, alreadyShown);
            if (day != 0L) {
                CustomRecipeMod.LOGGER.info("[Custom Recipes] Editor tip skipped: world is no longer on day 0.");
                return;
            }
            if (!WorldRecipeAssignments.markEditorTipShown(worldId, levelName, worldInstanceId)) {
                CustomRecipeMod.LOGGER.info("[Custom Recipes] Editor tip skipped: this world is already marked as shown.");
                return;
            }
            ...
            CustomRecipeMod.LOGGER.info("[Custom Recipes] Editor tip sent to chat.");
        });
