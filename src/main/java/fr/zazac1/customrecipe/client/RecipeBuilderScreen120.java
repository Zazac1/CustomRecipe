...
public class RecipeBuilderScreen120 extends Screen {
    ...
    // â”€â”€ persistent state (survives clearAndInit) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    public RecipeBuilderScreen120(ConfigScreen parent) {
    ...
    /** X of the top-left slot in the 3Ã—3 grid */
    private int gridX() {
    ...
    protected void init() {
        ...
        addDrawableChild(makeRightLabel(settingsX(), countY, "Result x" + resultCount + ":", 0xCCCCCC));
        ...
        // â”€â”€ Bottom buttons â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    public boolean mouseScrolled(double mx, double my, double verticalAmount) {
        ...
        return super.mouseScrolled(mx, my, verticalAmount);
    }
    ...
    private void renderFills(DrawContext ctx, int mx, int my) {
        ...
        for (int i = 0; i <= used.size(); i++) {
            ...
            if (empty) ctx.drawText(textRenderer, "X", x + 6, y + 5, 0xFFFF7777, false);
            else {
    ...
    public boolean mouseClicked(double mx, double my, int button) {
        ...
        for (int r = 0; r < 3; r++) {
            for (int c = 0; c < 3; c++) {
                ...
                if (mx >= sx && mx < sx + SLOT && my >= sy && my < sy + SLOT) {
                    selectSlot(slot);
                    // Conserver itemFieldText et itemSugg â€” l'utilisateur n'a pas Ã  reÃ©crire
                    restoreFocus = 1;
                    clearAndInit();
                    return true;
                }
        ...
        // Click on text field â€” laisser super.mouseClicked gÃ©rer
        // pour que la sÃ©lection par drag fonctionne nativement
        if (itemField != null
